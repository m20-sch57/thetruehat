  ...
  <main>
    <div class="scrollable">
      ...
      <div class="layer">
        ...
        <label class="field w-300">
          <input class="input w-70" v-model.number="settings.delayTime">
          <span>+</span>
          <input class="input w-70" v-model.number="settings.explanationTime">
          <span>+</span>
          <input class="input w-70" v-model.number="settings.aftermathTime">
        </label>
      </div>
