...
__7.__ `io` <a name="sYouJoined">`sYouJoined`</a> - сигнал, посылаемый сервером при удачном подключении.
...
__13.__ `io` <a name="cListenerReady">`cListenerReady`</a> - функция, вызов которой обозначает, что игрок готов угадывать слова.

---

__14.__ `io` <a name="cSpeakerReady">`cSpeakerReady`</a> - функция, вызов которой обозначает, что игрок готов объяснять слова.

---

__15.__ `io` <a name="sExplanationStarted">`sExplanationStarted`</a> - сигнал, посылаемый сервером всем клиентам в начале объяснения слов.
...
__17.__ `io` <a name="сEndWordExplanation">`сEndWordExplanation`</a> - функция, вызов которой обозначает, что игрок закончил объяснять текущее слово.
...
__18.__ `io` <a name="sWordExplanationEnded">`sWordExplanationEnded`</a> - сигнал, посылаемый всем клиентам (может кроме `speaker`) когда объяснение одного слова закончилось.
...
__21.__ `io` <a name="cWordsEdited">`cWordsEdited`</a> - сигнал, посылаемый клиентом, когда все правки внесены.
